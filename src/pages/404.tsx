...
const NotFound: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 text-gray-800 font-default">
      <h1 className="text-6xl font-bold text-[#DD8604]">404</h1>
      ...
      <Link
        to="/"
        className="mt-6 px-6 py-3 bg-[#DD8604] text-white font-medium rounded-md shadow hover:bg-[#006a5c] transition-all"
      >
        Go Back Home
      </Link>
      <div className="mt-10">
